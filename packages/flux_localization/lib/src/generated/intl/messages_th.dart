...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m38(amount) => "คูปองนี้กำหนดให้ต้องซื้อขั้นต่ำ ${amount}";

  static String m39(value) => "ธุรกรรมขั้นต่ำ: ${value}";

  static String m40(minute) => "${minute} นาทีที่แล้ว";

  static String m41(month) => "${month} เดือนที่แล้ว";

  static String m42(store) => "สินค้าเพิ่มเติมจาก ${store}";

  static String m43(number) => "ต้องซื้อเป็นกลุ่มจำนวน ${number}";

  static String m44(itemCount) => "${itemCount} รายการ";

  static String m45(price) => "ราคารวมตัวเลือก: ${price}";

  static String m46(amount) => "ชำระเงิน ${amount}";

  static String m47(name) => " เพิ่ม${name} ลงในรถเข็นเรียบร้อยแล้ว";

  static String m48(total) => "จำนวน: ${total}";

  static String m49(name) => "ได้รับเงินจาก ${name}";

  static String m50(count) =>
      "คุณต้องการลบรายการ ${count} รายการออกจากรายการสิ่งที่อยากได้ของคุณหรือไม่?";

  static String m51(percent) => "ลด ${percent}%";

  static String m52(keyword) => "ผลการค้นหาสำหรับ: \'${keyword}\'";

  static String m53(keyword, count) => "${keyword} (${count} รายการ)";

  static String m54(keyword, count) => "${keyword} (${count} รายการ)";

  static String m55(second) => "${second} วินาทีที่แล้ว";

  static String m56(totalCartQuantity) =>
      "ตะกร้าสินค้า, ${totalCartQuantity} รายการ";

  static String m57(numberOfUnitsSold) => "ขายแล้ว: ${numberOfUnitsSold}";

  static String m58(price) => "เริ่มต้นที่ ${price}";

  static String m59(fieldName) => "ต้องกรอกช่อง ${fieldName}";

  static String m60(total) => "สินค้าทั้งหมด ${total} รายการ";

  static String m61(name) => "โอนเงินไปที่ ${name}";

  static String m62(price) => "สูงสุด ${price}";

  static String m63(amount) => "ใช้ ${amount} คะแนน";
  ...
  static String m65(time) => "ใช้ได้ถึงวันที่: ${time}";

  static String m66(date) => "ใช้ได้จนถึง ${date}";

  static String m67(number) => "เวอร์ชัน ${number}";

  static String m68(balance) => "ยอดเงินในกระเป๋าเงิน: ${balance}";

  static String m69(message) => "คำเตือน: ${message}";

  static String m70(defaultCurrency) =>
      "สกุลเงินที่เลือกไม่สามารถใช้กับคุณสมบัติกระเป๋าเงินได้ กรุณาเปลี่ยนเป็น ${defaultCurrency}";

  static String m71(length) => "เราพบสินค้า ${length} รายการ";

  static String m72(week) => "สัปดาห์ที่ ${week}";

  static String m73(name) => "ยินดีต้อนรับ ${name}";

  static String m74(year) => "${year} ปีที่แล้ว";

  static String m75(count) => "คุณกำลังเลือก ${count} รายการ";

  static String m76(total) => "คุณได้รับมอบหมายคำสั่งซื้อ #${total}";

  static String m77(type) => "คุณได้ผ่าน ${type}";

  static String m78(point) => "คุณมี \$point points";
