...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m39(value) => "Transazione minima: ${value}";

  static String m40(minute) => "${minute} minuti fa";

  static String m41(month) => "${month} mesi fa";

  static String m42(store) => "Altri prodotti da ${store}";

  static String m43(number) => "Deve essere acquistato in gruppi di ${number}";

  static String m44(itemCount) => "${itemCount} articoli";

  static String m45(price) => "Totale opzioni: ${price}";

  static String m46(amount) => "Paga ${amount}";

  static String m47(name) => "${name} aggiunto al carrello";

  static String m48(total) => "Qtà: ${total}";

  static String m49(name) => "Ricevuto denaro da ${name}";

  static String m50(count) => "Vuoi rimuovere ${count} articoli dai preferiti?";

  static String m51(percent) => "Sconto ${percent}%";

  static String m52(keyword) => "Risultati per: \'${keyword}\'";

  static String m53(keyword, count) => "${keyword} (${count} risultato)";

  static String m54(keyword, count) => "${keyword} (${count} risultati)";

  static String m55(second) => "${second} secondi fa";

  static String m56(totalCartQuantity) =>
      "Carrello, ${totalCartQuantity} articoli";

  static String m57(numberOfUnitsSold) => "Venduto: ${numberOfUnitsSold}";

  static String m58(price) => "A partire da ${price}";

  static String m59(fieldName) => "Il campo ${fieldName} è obbligatorio";

  static String m60(total) => "${total} prodotti";

  static String m61(name) => "Trasferisci denaro a ${name}";

  static String m62(price) => "Fino a ${price}";

  static String m63(amount) => "Usa ${amount} punti";
  ...
  static String m65(time) => "Valido fino al: ${time}";

  static String m66(date) => "Valido fino al ${date}";

  static String m67(number) => "Versione ${number}";

  static String m68(balance) => "Saldo portafoglio: ${balance}";

  static String m69(message) => "Attenzione: ${message}";
  ...
  static String m71(length) => "Abbiamo trovato ${length} prodotti";

  static String m72(week) => "Settimana ${week}";

  static String m73(name) => "Benvenuto ${name}";

  static String m74(year) => "${year} anni fa";

  static String m75(count) => "Stai selezionando ${count} articoli";

  static String m76(total) => "Hai assegnato l\'ordine n. ${total}";

  static String m77(type) => "Hai superato ${type}";

  static String m78(point) => "Hai ${point} punti";
