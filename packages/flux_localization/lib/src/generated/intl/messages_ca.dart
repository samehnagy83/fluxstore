...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m39(value) => "Transacció mínima: ${value}";

  static String m40(minute) => "fa ${minute} minuts";

  static String m41(month) => "Fa ${month} mesos";

  static String m42(store) => "Més de ${store}";

  static String m43(number) => "s\'ha de comprar en grups de ${number}";

  static String m44(itemCount) => "${itemCount} articles";

  static String m45(price) => "Total d\'opcions: ${price}";

  static String m46(amount) => "Pagar ${amount}";

  static String m47(name) => " S\'han afegit${name} al carretó correctament";

  static String m48(total) => "Quantitat: ${total}";

  static String m49(name) => "S\'ha rebut diners de ${name}";

  static String m50(count) =>
      "Vols eliminar ${count} element(s) de la teva llista de desitjos?";

  static String m51(percent) => "${percent}% de descompte";

  static String m52(keyword) => "Resultats de la cerca per a: \"${keyword}\"";

  static String m53(keyword, count) => "${keyword} (${count} element)";

  static String m54(keyword, count) => "${keyword} (${count} elements)";

  static String m55(second) => "fa ${second} segons";

  static String m56(totalCartQuantity) =>
      "Carret de compra, ${totalCartQuantity} articles";

  static String m57(numberOfUnitsSold) => "Venut: ${numberOfUnitsSold}";

  static String m58(price) => "A partir de ${price}";

  static String m59(fieldName) => "El camp ${fieldName} és obligatori";

  static String m60(total) => "${total} productes";

  static String m61(name) => "Transfereix diners a ${name}";

  static String m62(price) => "Fins a ${price}";

  static String m63(amount) => "Utilitza ${amount} punts";
  ...
  static String m65(time) => "Vàlid fins: ${time}";

  static String m66(date) => "Vàlid fins al ${date}";

  static String m67(number) => "Versió ${number}";

  static String m68(balance) => "Saldo de Wallet: ${balance}";

  static String m69(message) => "Avís: ${message}";
  ...
  static String m71(length) => "Hem trobat ${length} productes";

  static String m72(week) => "Setmana ${week}";

  static String m73(name) => "Benvingut/da ${name}";

  static String m74(year) => "Fa ${year} anys";

  static String m75(count) => "Estàs seleccionant ${count} element(s)";

  static String m76(total) => "T\'han assignat la comanda #${total}";

  static String m77(type) => "Has superat ${type}";

  static String m78(point) => "Tens ${point} punts";
