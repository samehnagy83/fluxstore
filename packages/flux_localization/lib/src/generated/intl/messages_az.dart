...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m20(day) => "${day} gün əvvəl";

  static String m21(total) => "~${total} km";

  static String m22(timeLeft) => "${timeLeft} müddətində bitir";

  static String m23(captcha) => "Təsdiqləmək üçün ${captcha} daxil edin:";

  static String m24(message) => "Xəta: ${message}";

  static String m25(message) => "Xəta: ${message}";

  static String m26(error) => "Xəta baş verdi: ${error}";

  static String m27(error) => "Xəta baş verdi: ${error}";

  static String m28(time) => "${time} müddətində başa çatır";

  static String m29(total) => "${total} km-dən çox";

  static String m30(hour) => "${hour} saat əvvəl";
  ...
  static String m34(size) => "Maksimum fayl ölçüsü: ${size} MB";
  ...
  static String m38(amount) => "Bu kupon minimum ${amount}alış tələb edir.";

  static String m39(value) => "Minimum əməliyyat: ${value}";

  static String m40(minute) => "${minute} dəqiqə əvvəl";

  static String m41(month) => "${month} ay əvvəl";

  static String m42(store) => "${store} mağazasından daha çox";

  static String m43(number) => " ${number}qruplarında alınmalıdır ";

  static String m44(itemCount) => "${itemCount} məhsul";

  static String m45(price) => "Cəmi seçimlər: ${price}";

  static String m46(amount) => " ${amount}ödəyin ";

  static String m47(name) => "${name} səbətə uğurla əlavə edildi";

  static String m48(total) => "Miqdar: ${total}";

  static String m49(name) => " ${name}tərəfindən pul alındı ";

  static String m50(count) =>
      "İstək siyahınızdan ${count} elementi silmək istəyirsiniz?";

  static String m51(percent) => "${percent}% endirim";

  static String m52(keyword) => "Axtarış nəticələri: \'${keyword}\'";

  static String m53(keyword, count) => "${keyword} (${count} element)";

  static String m54(keyword, count) => "${keyword} (${count} element)";

  static String m55(second) => "${second} saniyə əvvəl";

  static String m56(totalCartQuantity) => "Səbət, ${totalCartQuantity} məhsul";

  static String m57(numberOfUnitsSold) => "Satıldı: ${numberOfUnitsSold}";

  static String m58(price) => "${price}-dən başlayır";

  static String m59(fieldName) => " ${fieldName} sahəsi tələb olunur";

  static String m60(total) => "${total} məhsul";

  static String m61(name) => " ${name}hesabına pul köçürün ";

  static String m62(price) => "${price}-ə qədər";

  static String m63(amount) => " ${amount} xal istifadə edin";
  ...
  static String m65(time) => "Bu tarixə qədər etibarlıdır: ${time}";

  static String m66(date) => " ${date}tarixinə qədər etibarlıdır ";

  static String m67(number) => "Versiya ${number}";

  static String m68(balance) => "Pulqabı balansı: ${balance}";

  static String m69(message) => "Xəbərdarlıq: ${message}";
  ...
  static String m71(length) => "${length} məhsul tapıldı";

  static String m72(week) => "Həftə ${week}";

  static String m73(name) => "Xoş gəldiniz ${name}";

  static String m74(year) => "${year} il əvvəl";

  static String m75(count) => "Siz ${count} element(lər) seçirsiniz";

  static String m76(total) => "Siz №${total}sifariş üçün təyin olundunuz ";

  static String m77(type) => "Siz ${type}keçdiniz ";

  static String m78(point) => "${point} xalınız var";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "brandsForLess": MessageLookupByLibrary.simpleMessage("Daha Ucuz Brendlər"),
