...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m39(value) => "Минимальная транзакция: ${value}";

  static String m40(minute) => "${minute} минут назад";

  static String m41(month) => "${month} месяцев назад";

  static String m42(store) => "Еще из ${store}";

  static String m43(number) => "Необходимо покупать группами по ${number}";

  static String m44(itemCount) => "${itemCount} товаров";

  static String m45(price) => "Всего опций: ${price}";

  static String m46(amount) => "Оплатить ${amount}";

  static String m47(name) => "Товар ${name} добавлен в корзину";

  static String m48(total) => "Кол-во: ${total}";

  static String m49(name) => "Получены деньги от ${name}";

  static String m50(count) => "Удалить ${count} товар(ов) из списка желаний?";

  static String m51(percent) => "Скидка ${percent}%";

  static String m52(keyword) => "Результаты поиска для \'${keyword}\'";

  static String m53(keyword, count) => "${keyword} (${count} товар)";

  static String m54(keyword, count) => "${keyword} (${count} товаров)";

  static String m55(second) => "${second} секунд назад";

  static String m56(totalCartQuantity) =>
      "Корзина, ${totalCartQuantity} товаров";

  static String m57(numberOfUnitsSold) => "Продано: ${numberOfUnitsSold}";

  static String m58(price) => "От ${price}";

  static String m59(fieldName) =>
      "Поле ${fieldName} обязательно для заполнения";

  static String m60(total) => "${total} товаров";

  static String m61(name) => "Перевести деньги пользователю ${name}";

  static String m62(price) => "До ${price}";

  static String m63(amount) => "Используйте ${amount} баллов";
  ...
  static String m65(time) => "Действительно до: ${time}";

  static String m66(date) => "Действительно до ${date}";

  static String m67(number) => "Версия ${number}";

  static String m68(balance) => "Баланс кошелька: ${balance}";

  static String m69(message) => "Предупреждение: ${message}";

  static String m70(defaultCurrency) =>
      "Выбранная валюта недоступна для функции Кошелька. Измените ее на ${defaultCurrency}";

  static String m71(length) => "Мы нашли товары";

  static String m72(week) => "Неделя ${week}";

  static String m73(name) => "Добро пожаловать, ${name}";

  static String m74(year) => "${year} лет назад";

  static String m75(count) => "Вы выбираете ${count} товар(ов)";

  static String m76(total) => "Вам назначен заказ №${total}";

  static String m77(type) => "Вы прошли ${type}";

  static String m78(point) => "У вас есть ${point} баллов";
