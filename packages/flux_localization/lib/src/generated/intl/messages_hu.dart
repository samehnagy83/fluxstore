...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m39(value) => "Minimális tranzakció: ${value}";

  static String m40(minute) => "${minute} perce";

  static String m41(month) => "${month} hónappal ezelőtt";

  static String m42(store) => "További termékek innen: ${store}";

  static String m43(number) => "${number} darabos csomagban vásárolható";

  static String m44(itemCount) => "${itemCount} termék";

  static String m45(price) => "Opciók összesen: ${price}";

  static String m46(amount) => "Fizetés: ${amount}";

  static String m47(name) => "A(z) ${name} sikeresen a kosárba került";

  static String m48(total) => "Mennyiség: ${total}";

  static String m49(name) => "Pénz érkezett tőle: ${name}";

  static String m50(count) =>
      "Eltávolít ${count} terméket a kívánságlistájáról?";

  static String m51(percent) => "${percent}% kedvezmény";

  static String m52(keyword) => "Keresési eredmények erre: \"${keyword}\"";

  static String m53(keyword, count) => "${keyword} (${count} találat)";

  static String m54(keyword, count) => "${keyword} (${count} találat)";

  static String m55(second) => "${second} másodperce";

  static String m56(totalCartQuantity) => "Kosár, ${totalCartQuantity} termék";

  static String m57(numberOfUnitsSold) => "Eladva: ${numberOfUnitsSold}";

  static String m58(price) => "Kezdőár: ${price}";

  static String m59(fieldName) => "A(z) ${fieldName} mező kötelező";

  static String m60(total) => "${total} termék";

  static String m61(name) => "Pénz küldése neki: ${name}";

  static String m62(price) => "Legfeljebb ${price}";

  static String m63(amount) => "Használjon ${amount} pontot";
  ...
  static String m65(time) => "Érvényes eddig: ${time}";

  static String m66(date) => "Érvényes: ${date}";

  static String m67(number) => "Verzió: ${number}";

  static String m68(balance) => "Egyenleg: ${balance}";

  static String m69(message) => "Figyelmeztetés: ${message}";
  ...
  static String m71(length) => "Találtunk ${length} terméket";

  static String m72(week) => "${week}. hét";

  static String m73(name) => "Üdvözöljük, ${name}!";

  static String m74(year) => "${year} évvel ezelőtt";

  static String m75(count) => "${count} terméket választott ki";

  static String m76(total) => "A(z) ${total} számú rendelést kapta";

  static String m77(type) => "Lejárt ${type}";

  static String m78(point) => "Jelenleg ${point} pontja van";
