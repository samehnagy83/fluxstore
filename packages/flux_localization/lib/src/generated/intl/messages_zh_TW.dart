...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m38(amount) => "此優惠券要求最低購買金額為 ${amount}。";

  static String m39(value) => "最低交易次數： ${value}";

  static String m40(minute) => "${minute} 分鐘前";

  static String m41(month) => "${month} 個月前";

  static String m42(store) => "${store}的更多商品";

  static String m43(number) => "必須以${number}為一組購買";

  static String m44(itemCount) => "${itemCount} 個項目";

  static String m45(price) => "選項總計：${price}";

  static String m46(amount) => "支付${amount}";

  static String m47(name) => "${name}已成功加入購物車";

  static String m48(total) => "數量：${total}";

  static String m49(name) => "收到來自${name}的款項";

  static String m50(count) => "您想從心願清單中刪除 ${count} 件商品嗎？";

  static String m51(percent) => "特價 ${percent}%";

  static String m52(keyword) => "「${keyword}」的搜尋結果";

  static String m53(keyword, count) => "${keyword}（${count}項）";

  static String m54(keyword, count) => "${keyword}（${count}項）";

  static String m55(second) => "${second}秒前";

  static String m56(totalCartQuantity) => "購物車，${totalCartQuantity}件商品";

  static String m57(numberOfUnitsSold) => "已售出：${numberOfUnitsSold}";

  static String m58(price) => "起價 ${price}";

  static String m59(fieldName) => "${fieldName}為必填欄位";

  static String m60(total) => "${total}項商品";

  static String m61(name) => "轉帳給${name}";

  static String m62(price) => "最高 ${price}";

  static String m63(amount) => "使用 ${amount} 積分";

  static String m64(maxPointDiscount, maxPriceDiscount) =>
      "使用最多${maxPointDiscount}點積分可獲得此訂單${maxPriceDiscount}的折扣！";

  static String m65(time) => "有效期限至： ${time}";

  static String m66(date) => "有效期至 ${date}";

  static String m67(number) => "版本 ${number}";

  static String m68(balance) => "錢包餘額：${balance}";

  static String m69(message) => "警告：${message}";

  static String m70(defaultCurrency) => "目前選擇的貨幣不適用於錢包功能，請改為${defaultCurrency}";

  static String m71(length) => "我們找到了${length}項商品";

  static String m72(week) => "第${week}週";

  static String m73(name) => "歡迎${name}";

  static String m74(year) => "${year}年前";

  static String m75(count) => "您正在選擇 ${count} 項";

  static String m76(total) => "您已指派至訂單#${total}";

  static String m77(type) => "您已通過 ${type}";

  static String m78(point) => "您有${point}點積分";
