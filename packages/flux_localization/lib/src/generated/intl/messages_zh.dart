...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m38(amount) => "此优惠券要求最低购买金额为 ${amount}。";

  static String m39(value) => "最低交易次数： ${value}";

  static String m40(minute) => "${minute} 分钟前";

  static String m41(month) => "${month} 个月前";

  static String m42(store) => "${store}的更多商品";

  static String m43(number) => "必须按${number}件为单位购买";

  static String m44(itemCount) => "${itemCount} 件商品";

  static String m45(price) => "选项总计：${price}";

  static String m46(amount) => "支付${amount}";

  static String m47(name) => "已将${name}添加到购物车";

  static String m48(total) => "数量：${total}";

  static String m49(name) => "已收到来自${name}的款项";

  static String m50(count) => "是否要从心愿单中移除${count}件商品？";

  static String m51(percent) => "优惠 ${percent}%";

  static String m52(keyword) => "\"${keyword}\"的搜索结果";

  static String m53(keyword, count) => "${keyword}（${count}项）";

  static String m54(keyword, count) => "${keyword}（${count}项）";

  static String m55(second) => "${second} 秒前";

  static String m56(totalCartQuantity) => "购物车，${totalCartQuantity} 件商品";

  static String m57(numberOfUnitsSold) => "已售出：${numberOfUnitsSold}";

  static String m58(price) => "起价 ${price}";

  static String m59(fieldName) => "${fieldName}为必填项";

  static String m60(total) => "${total} 个商品";

  static String m61(name) => "转账给${name}";

  static String m62(price) => "最高 ${price}";

  static String m63(amount) => "使用 ${amount} 积分";

  static String m64(maxPointDiscount, maxPriceDiscount) =>
      "使用${maxPointDiscount}积分可获得此订单${maxPriceDiscount}的折扣！";

  static String m65(time) => "有效期至: ${time}";

  static String m66(date) => "有效期至 ${date}";

  static String m67(number) => "版本 ${number}";

  static String m68(balance) => "钱包余额：${balance}";

  static String m69(message) => "警告：${message}";

  static String m70(defaultCurrency) => "当前选择的货币不支持钱包功能，请改为${defaultCurrency}";

  static String m71(length) => "找到 ${length} 个商品";

  static String m72(week) => "第 ${week} 周";

  static String m73(name) => "欢迎，${name}";

  static String m74(year) => "${year}年前";

  static String m75(count) => "您已选择${count}个商品";

  static String m76(total) => "您已被分配订单#${total}";

  static String m77(type) => "您已通过 ${type}";

  static String m78(point) => "您有 ${point} 积分";
