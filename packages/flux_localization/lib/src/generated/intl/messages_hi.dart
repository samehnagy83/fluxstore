...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m39(value) => "न्यूनतम लेनदेन: ${value}";

  static String m40(minute) => "${minute} मिनट पहले";

  static String m41(month) => "${month} महीने पहले";

  static String m42(store) => "${store} से और";

  static String m43(number) => "${number} के समूह में खरीदा जाना चाहिए";

  static String m44(itemCount) => "${itemCount} आइटम";

  static String m45(price) => "विकल्पों का कुल: ${price}";

  static String m46(amount) => "${amount} का भुगतान करें";

  static String m47(name) => "${name} सफलतापूर्वक कार्ट में जोड़ा गया";

  static String m48(total) => "मात्रा: ${total}";

  static String m49(name) => "${name} से पैसे प्राप्त हुए";

  static String m50(count) =>
      "क्या आप अपनी इच्छा-सूची से ${count} वस्तु हटाना चाहते हैं?";

  static String m51(percent) => "बिक्री ${percent}%";

  static String m52(keyword) => "\'${keyword}\' के लिए खोज परिणाम";

  static String m53(keyword, count) => "${keyword} (${count} आइटम)";

  static String m54(keyword, count) => "${keyword} (${count} आइटम)";

  static String m55(second) => "${second} सेकंड पहले";

  static String m56(totalCartQuantity) =>
      "शॉपिंग कार्ट, ${totalCartQuantity} आइटम";

  static String m57(numberOfUnitsSold) => "बिक गया: ${numberOfUnitsSold}";

  static String m58(price) => "${price} से शुरू";

  static String m59(fieldName) => "${fieldName} फ़ील्ड आवश्यक है";

  static String m60(total) => "कुल उत्पाद: ${total}";

  static String m61(name) => "${name} को पैसे भेजें";

  static String m62(price) => "अधिकतम ${price} तक";

  static String m63(amount) => " ${amount} अंक का उपयोग करें";
  ...
  static String m65(time) => " ${time}तक वैध";

  static String m66(date) => "${date} तक मान्य";

  static String m67(number) => "संस्करण ${number}";

  static String m68(balance) => "वॉलेट में शेष: ${balance}";

  static String m69(message) => "चेतावनी: ${message}";
  ...
  static String m71(length) => "हमें ${length} उत्पाद मिले";

  static String m72(week) => "सप्ताह ${week}";

  static String m73(name) => "स्वागत है ${name}";

  static String m74(year) => "${year} साल पहले";

  static String m75(count) => "आप ${count} वस्तु चुन रहे हैं";

  static String m76(total) => "आपको ऑर्डर #${total} असाइन किया गया है";

  static String m77(type) => "आप ${type}पार कर चुके हैं";

  static String m78(point) => "आपके पास ${point} अंक हैं";
