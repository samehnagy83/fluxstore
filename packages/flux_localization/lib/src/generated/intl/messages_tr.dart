...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m39(value) => "Min işlem: ${value}";

  static String m40(minute) => "${minute} dakika önce";

  static String m41(month) => "${month} ay önce";

  static String m42(store) => "${store} mağazasından daha fazlası";

  static String m43(number) =>
      "${number} adetlik gruplar halinde satın alınmalıdır";

  static String m44(itemCount) => "${itemCount} ürün";

  static String m45(price) => "Toplam seçenek: ${price}";

  static String m46(amount) => "${amount} ile öde";

  static String m47(name) => "${name} sepete eklendi";

  static String m48(total) => "Adet: ${total}";

  static String m49(name) => "${name} tarafından para alındı";

  static String m50(count) =>
      "İstek listenizden ${count} ürünü kaldırmak istiyor musunuz?";

  static String m51(percent) => "%${percent} İndirim";

  static String m52(keyword) => "\'${keyword}\' için arama sonuçları";

  static String m53(keyword, count) => "${keyword} (${count} ürün)";

  static String m54(keyword, count) => "${keyword} (${count} ürün)";

  static String m55(second) => "${second} saniye önce";

  static String m56(totalCartQuantity) => "Sepet, ${totalCartQuantity} ürün";

  static String m57(numberOfUnitsSold) => "Satıldı: ${numberOfUnitsSold}";

  static String m58(price) => "${price} başlangıç fiyatı";

  static String m59(fieldName) => "${fieldName} alanı zorunludur";

  static String m60(total) => "${total} ürün";

  static String m61(name) => "${name} hesabına para transferi";

  static String m62(price) => "En fazla ${price}";

  static String m63(amount) => " ${amount} puan kullan";
  ...
  static String m65(time) => "Geçerlilik tarihi: ${time}";

  static String m66(date) => "${date} tarihine kadar geçerli";

  static String m67(number) => "Sürüm ${number}";

  static String m68(balance) => "Cüzdan bakiyesi: ${balance}";

  static String m69(message) => "Uyarı: ${message}";
  ...
  static String m71(length) => "${length} Ürün Bulundu";

  static String m72(week) => "${week}. hafta";

  static String m73(name) => "Hoş geldin ${name}";

  static String m74(year) => "${year} yıl önce";

  static String m75(count) => "${count} ürün seçiyorsunuz";

  static String m76(total) => "#${total} numaralı siparişe atandınız";

  static String m77(type) => " ${type}geçtiniz";

  static String m78(point) => "${point} Puanınız Var";
