...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m39(value) => "Mindesttransaktion: ${value}";

  static String m40(minute) => "Vor ${minute} Minuten";

  static String m41(month) => "Vor ${month} Monaten";

  static String m42(store) => "Mehr von ${store}";

  static String m43(number) => "Muss in Gruppen von ${number} gekauft werden";

  static String m44(itemCount) => "${itemCount} Artikel";

  static String m45(price) => "Gesamtoptionen: ${price}";

  static String m46(amount) => "${amount} bezahlen";

  static String m47(name) => "${name} wurde zum Warenkorb hinzugefügt";

  static String m48(total) => "Menge: ${total}";

  static String m49(name) => "Geld erhalten von ${name}";

  static String m50(count) =>
      "Möchten Sie ${count} Artikel von Ihrer Wunschliste entfernen?";

  static String m51(percent) => "${percent}% Rabatt";

  static String m52(keyword) => "Suchergebnisse für \'${keyword}\'";

  static String m53(keyword, count) => "${keyword} (${count} Artikel)";

  static String m54(keyword, count) => "${keyword} (${count} Artikel)";

  static String m55(second) => "Vor ${second} Sekunden";

  static String m56(totalCartQuantity) =>
      "Warenkorb, ${totalCartQuantity} Artikel";

  static String m57(numberOfUnitsSold) => "Verkauft: ${numberOfUnitsSold}";

  static String m58(price) => "Ab ${price}";

  static String m59(fieldName) => "Das Feld ${fieldName} ist erforderlich";

  static String m60(total) => "${total} Produkte";

  static String m61(name) => "Geld überweisen an ${name}";

  static String m62(price) => "Bis zu ${price}";

  static String m63(amount) => "${amount} Punkte einlösen";
  ...
  static String m65(time) => "Gültig bis: ${time}";

  static String m66(date) => "Gültig bis ${date}";

  static String m67(number) => "Version ${number}";

  static String m68(balance) => "Guthaben: ${balance}";

  static String m69(message) => "Warnung: ${message}";
  ...
  static String m71(length) => "Gefundene Produkte";

  static String m72(week) => "Woche ${week}";

  static String m73(name) => "Willkommen ${name}";

  static String m74(year) => "Vor ${year} Jahren";

  static String m75(count) => "Sie haben ${count} Artikel ausgewählt";

  static String m76(total) => "Sie wurden der Bestellung #${total} zugewiesen";

  static String m77(type) => "Sie haben ${type} bestanden";

  static String m78(point) => "Sie haben ${point} Punkte";
