...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m39(value) => "Minimalna transakcja: ${value}";

  static String m40(minute) => "${minute} min temu";

  static String m41(month) => "${month} miesięcy temu";

  static String m42(store) => "Więcej od ${store}";

  static String m43(number) => "Musi być kupowane w grupach po ${number}";

  static String m44(itemCount) => "${itemCount} elementów";

  static String m45(price) => "Suma opcji: ${price}";

  static String m46(amount) => "Zapłać ${amount}";

  static String m47(name) => "Produkt ${name} został dodany do koszyka";

  static String m48(total) => "Ilość: ${total}";

  static String m49(name) => "Otrzymano środki od ${name}";

  static String m50(count) =>
      "Czy chcesz usunąć ${count} pozycji z listy życzeń?";

  static String m51(percent) => "Wyprzedaż ${percent}%";

  static String m52(keyword) => "Wyniki wyszukiwania dla: \'${keyword}\'";

  static String m53(keyword, count) => "${keyword} (${count} element)";

  static String m54(keyword, count) => "${keyword} (${count} elementów)";

  static String m55(second) => "${second} sekund temu";

  static String m56(totalCartQuantity) =>
      "Koszyk, ${totalCartQuantity} pozycji";

  static String m57(numberOfUnitsSold) => "Sprzedane: ${numberOfUnitsSold}";

  static String m58(price) => "Cena od ${price}";

  static String m59(fieldName) => "Pole ${fieldName} jest wymagane";

  static String m60(total) => "${total} produktów";

  static String m61(name) => "Przelej pieniądze do ${name}";

  static String m62(price) => "Do ${price}";

  static String m63(amount) => "Użyj ${amount} punktów";
  ...
  static String m65(time) => "Ważne do: ${time}";

  static String m66(date) => "Ważne do ${date}";

  static String m67(number) => "Wersja ${number}";

  static String m68(balance) => "Saldo portfela: ${balance}";

  static String m69(message) => "Ostrzeżenie: ${message}";
  ...
  static String m71(length) => "Znaleźliśmy ${length} produktów";

  static String m72(week) => "Tydzień ${week}";

  static String m73(name) => "Witaj ${name}";

  static String m74(year) => "${year} lat temu";

  static String m75(count) => "Wybierasz ${count} produktów";

  static String m76(total) => "Przypisano do zamówienia nr ${total}";

  static String m77(type) => "Zdałeś ${type}";

  static String m78(point) => "Masz ${point} punktów";
