...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m39(value) => "Transaksi min: ${value}";

  static String m40(minute) => "${minute} menit yang lalu";

  static String m41(month) => "${month} bulan yang lalu";

  static String m42(store) => "Lainnya dari ${store}";

  static String m43(number) => "Harus dibeli dalam kelompok ${number}";

  static String m44(itemCount) => "${itemCount} item";

  static String m45(price) => "Total opsi: ${price}";

  static String m46(amount) => "Bayar ${amount}";

  static String m47(name) => "${name} berhasil ditambahkan ke keranjang";

  static String m48(total) => "Jumlah: ${total}";

  static String m49(name) => "Menerima uang dari ${name}";

  static String m50(count) =>
      "Apakah Anda ingin menghapus ${count} item dari daftar keinginan?";

  static String m51(percent) => "Diskon ${percent}%";

  static String m52(keyword) => "Hasil pencarian untuk: \'${keyword}\'";

  static String m53(keyword, count) => "${keyword} (${count} barang)";

  static String m54(keyword, count) => "${keyword} (${count} barang)";

  static String m55(second) => "${second} detik yang lalu";

  static String m56(totalCartQuantity) =>
      "Keranjang Belanja, ${totalCartQuantity} item";

  static String m57(numberOfUnitsSold) => "Terjual: ${numberOfUnitsSold}";

  static String m58(price) => "Mulai dari ${price}";

  static String m59(fieldName) => "Bidang ${fieldName} wajib diisi";

  static String m60(total) => "${total} produk";

  static String m61(name) => "Transfer uang ke ${name}";

  static String m62(price) => "Hingga ${price}";

  static String m63(amount) => "Gunakan ${amount} poin";
  ...
  static String m65(time) => "Berlaku sampai: ${time}";

  static String m66(date) => "Berlaku hingga ${date}";

  static String m67(number) => "Versi ${number}";

  static String m68(balance) => "Saldo dompet: ${balance}";

  static String m69(message) => "Peringatan: ${message}";
  ...
  static String m71(length) => "Kami menemukan ${length} produk";

  static String m72(week) => "Minggu ${week}";

  static String m73(name) => "Selamat datang ${name}";

  static String m74(year) => "${year} tahun yang lalu";

  static String m75(count) => "Anda memilih ${count} item";

  static String m76(total) => "Anda telah ditugaskan untuk pesanan #${total}";

  static String m77(type) => "Anda telah melewati ${type}";

  static String m78(point) => "Anda memiliki ${point} poin";
