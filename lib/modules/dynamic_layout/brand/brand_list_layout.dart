                        ...
                        GridView.count(
                          ...
                          children: List.generate(
                            ...
                            (i) => BrandItem(
                              ...
                              isBrandNameShown:
                                  config?.isBrandNameShown ?? true,
                              isLogoCornerRounded:
                                  config?.isLogoCornerRounded ?? true,
                            ),
                          ),
                        ),
                      ],
              ...
              builder: (_, model, __) => SliverGrid.count(
                ...
                children: List.generate(
                  ...
                  (i) => BrandItem(
                    ...
                    isBrandNameShown: config?.isBrandNameShown ?? true,
                    isLogoCornerRounded: config?.isLogoCornerRounded ?? true,
                  ),
                ),
              ),
            )
