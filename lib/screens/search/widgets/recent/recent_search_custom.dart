...
class RecentSearchesCustom extends StatelessWidget {
    ...
    return Consumer<SearchModel>(
      builder: (context, model, child) {
        ...
        return (keywords.isEmpty)
            ? renderEmpty(context)
            : renderKeywords(
                model, widthContent, context, keywords, productType);
      },
    );
  }
  ...
  Widget renderKeywords(SearchModel model, double widthContent,
      BuildContext context, List<String> keywords, bool productType) {
    return ListView(
      shrinkWrap: true,
      children: <Widget>[
        Container(
