...
class WordPressService extends BaseServices {
  ...
  WordPressService({
    ...
    bool? isRoot,
        ...
        _connector =
            WordpressConnector(WordpressApi(domain, isRoot: isRoot ?? true)),
        super(
  ...
  Future<User> loginSMS({String? token}) async {
    try {
      ...
      var response = await _connector.httpPost(endPoint.toUri()!,
  ...
  Future<void> createBlog(
    ...
    try {
      ...
      var response =
          await _connector.httpPost(endPoint!, body: data, enableDio: true);
      if (response.statusCode != 200) {
